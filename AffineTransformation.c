...
int main()
{
	...
	yo1 = Oy1 - yg;
	printf("yo1 değeri: %Lf\n", yo1);
	xo2 = Ox2 - xg;
	printf("xo2 değeri: %Lf\n", xo2);
	yo2 = Oy2 - yg;
	printf("yo2 değeri: %Lf\n", yo2);
	xo3 = Ox3 - xg;
	printf("xo3 değeri: %Lf\n", xo3);
	yo3 = Oy3 - yg;
	printf("yo3 değeri: %Lf\n", yo3);
	xo4 = Ox4 - xg;
	printf("xo4 değeri: %Lf\n", xo4);
	yo4 = Oy4 - yg;
	printf("yo4 değeri: %Lf\n", yo4);
	Xo1 = OX1 - Xg;
	printf("Xo1 değeri: %Lf\n", Xo1);
	Yo1 = OY1 - Yg;
	printf("Yo1 değeri: %Lf\n", Yo1);
	...
	Vy1 = Yd1 - OY1;
	printf("Vy1 değeri: %Lf\n", Vy1);
	Vx2 = Xd2 - OX2;
	printf("Vx2 değeri: %Lf\n", Vx2);
	Vy2 = Yd2 - OY2;
	printf("Vy2 değeri: %Lf\n", Vy2);
	Vx3 = Xd3 - OX3;
	printf("Vx3 değeri: %Lf\n", Vx3);
	Vy3 = Yd3 - OY3;
	printf("Vy3 değeri: %Lf\n", Vy3);
	Vx4 = Xd4 - OX4;
	printf("Vx4 değeri: %Lf\n", Vx4);
	Vy4 = Yd4 - OY4;
	printf("Vy4 değeri: %Lf\n", Vy4);
